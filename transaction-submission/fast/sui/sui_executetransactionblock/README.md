...
Fast模式基於BlockRazor的全球高性能網絡實現交易最低延遲上鏈，適合對交易上鏈速度存在極致要求的用戶。Fast模式支持gRPC協議，gRPC協議的交易發送方法和[`sui/rpc/v2/transaction_execution_service.proto`](https://docs.sui.io/references/fullnode-protocol#sui_rpc_v2_transaction-execution-service-proto) 兼容。
